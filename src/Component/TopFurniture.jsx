...
const TopFurniture = () => {
  ...
  if (!isLoading) {
    const topFurnitureProducts = products.filter((product)=>{
        return product.department === "furniture"
    })

    const topFurniture = topFurnitureProducts.slice(0, 6);
      ...
      >
        <div className="max-w-screen-xl mx-auto">
          <h1 className="text-3xl md:text-5xl text-center my-12">
            Top <span className="text-ylw">Furniture</span>
          </h1>
